(function($) {
	...
	$.fn.myParallax = function(options) {
		...
		return this.each(function () {
			...
			.wrapInner("<div class='parallax-content' style='position:relative;z-index:10'>")
			.prepend("<div class='image-parallax' style='background-image:url(" + ths.data('parallax-image') + ");background-size:cover;background-position:top;position:absolute;top:0px;width:100%'>");
